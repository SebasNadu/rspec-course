...
RSpec.describe Movie do
  let(:stuntman) { double("Mr. Danger", ready?: true, act: 'Any String at all', fall_off_ladder: 'Sure! Lets go it', light_on_fire: true) }

  subject { described_class.new(stuntman) }

  describe '#start_shooting method' do
    it 'expects on actor to do 3 actions' do
